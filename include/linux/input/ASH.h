...
typedef struct SAR_sensor_hw {	
	...
	int (*SAR_sensor_hw_turn_onoff)(bool bOn, int channel);
	int (*SAR_sensor_hw_get_adc)(void);
	int (*SAR_sensor_hw_get_proxavg_value)(void);
	int (*SAR_sensor_hw_get_proxdiff_value)(void);
	int (*SAR_sensor_hw_get_proxthresh0_value)(void);
	int (*SAR_sensor_hw_set_proxthresh0_value)(int value);
}SAR_sensor_hw;
...
typedef struct{ 
	...
	int (*SAR_sensor_show_adc_value)(void);
	int (*SAR_sensor_show_proxavg_value)(void);
	int (*SAR_sensor_show_proxdiff_value)(void);
...
typedef struct{
	...
	int (*SAR_sensor_show_switch_channel)(void);
	int (*SAR_sensor_store_switch_channel)(int channel);
...
typedef struct{
	...
	int (*SAR_show_proxthresh0_reg)(void);
	int (*SAR_store_proxthresh0_reg)(int value);	
