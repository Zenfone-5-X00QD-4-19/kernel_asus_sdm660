...
#define CHECK_OIS_DATA_LEN (128)//ASUS_BSP Lucien +++
#define DISABLE_OIS_LEN (64)//ASUS_BSP Lucien +++
...
#define PROC_FILE_CAMERA_RES   "driver/camera_res" //ASUS_BSP Lucien +++: Add node for reading camera resolutions

#define PROC_FILE_OV_FRONTCAM   "driver/OVFrontCamera"//ASUS_BSP	+++ Ryan "distinguish ov module version"
#define PROC_FILE_OV_REARCAM   "driver/OVRearCamera"//ASUS_BSP	+++ Ryan "distinguish ov module version"
...
//ASUS_BSP Lucien ---: Add node for reading camera resolutions
 ...
 extern int32_t ois_read_hw_version(bool vcm); //ASUS_BSP Lucien +++: Forcing set ois to center mode with ER1 hw for Ara project
