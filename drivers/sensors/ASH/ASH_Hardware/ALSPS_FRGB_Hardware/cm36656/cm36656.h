...
#define CM36656_PROXIMITY_THDL_DEFAULT  	(39)
#define CM36656_PROXIMITY_THDH_DEFAULT  	(88)
#define CM36656_PROXIMITY_INF_DEFAULT  		(20)
#define CM36656_PROXIMITY_AUTOK_MIN  		(3)
#define CM36656_PROXIMITY_AUTOK_MAX  		(150)
#define CM36656_LIGHT_CALIBRATION_DEFAULT   (1565)
